...
export class VideoPlayer {
    ...
    createMobileVideo() {
        ...
        this.mobileVideoElement.style.width = 'min(90vw, 500px)';
        this.mobileVideoElement.style.height = 'auto';
        this.mobileVideoElement.style.zIndex = '1';
        ...
        this.mobileVideoElement.style.transition = 'opacity 0.3s ease-in-out';
    ...
    /**
     * Create 3D scene for mobile (without video texture)
     */
    createMobile3DScene() {
